...
pyautogui.screenshot(r'C:\region_screenshot.png', region=(0, 0, 300, 300))
...
sub = endTime.second -startTime.second
...
a = pyautogui.locateOnScreen(r'C:\region_screenshot.png')  #定位截图的位置 左顶点，宽高
print(a)                                                   # 打印结果为Box(left=0, top=0, width=300, height=400)

x, y = pyautogui.center(a)  # 获得文件图片在现在的屏幕上面的中心坐标
print(x, y)                 # 打印结果为150 200
x, y = pyautogui.locateCenterOnScreen(r'C:\region_screenshot.png')  #定位截图的中心坐标
print(x, y)  # 打印结果为150 200
