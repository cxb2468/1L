...
import cv2,time,random,os, datetime,sys
...
class Main_Win(QWidget):
    def __init__(self):
        ...
        self.Main_WinUI()
        self.initial= script.script()


    def Main_WinUI(self):
        self.setWindowTitle('梦幻模拟战')
        self.resize(500,700)
        ...
        palette = QPalette()
        pix = QPixmap(os.getcwd() + "\\png\\background.jpg")
        ...
        self.setWindowIcon(QIcon(os.getcwd() + "\\png\\favicon.ico"))
    ...
    def dialoginfo_three(self):
        ...
        reply=QMessageBox.question(win, '温馨提示！', '开始执行！', QMessageBox.Ok)
        scriptDef.alarm(1)
        QMessageBox.question(win, '温馨提示！', '还未写入功能！', QMessageBox.Ok)
